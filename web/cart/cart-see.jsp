...
<form method="post" name="form1" action="cart-modify.jsp">
    <table width="92%" height="48" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        else
        {
            ...
            Vector ct=(Vector)session.getAttribute("ct");//自动增长的对象数组
            if (ct==null||ct.size()==0)
            {
                out.println("<script language='javascript'>window.location.href='cart/cart-null.jsp';</script>");
            }
            else
            {
                int sum=0;
